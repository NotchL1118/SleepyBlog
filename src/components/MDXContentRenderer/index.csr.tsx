/**
 * Custom MDX Remote Client Version
 *
...
import { MDXClient, type SerializeResult as ClientSerializeResult } from "next-mdx-remote-client/csr";
import ErrorComponent from "./ErrorComponent";

interface CustomMDXRemoteClientProps {
  mdxSource: ClientSerializeResult<Record<string, unknown>, Record<string, unknown>>;
}
