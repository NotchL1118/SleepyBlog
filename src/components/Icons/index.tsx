...
// 顶部箭头图标组件,用于返回顶部
export const TopArrowIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
// 复制图标组件
export const CopyIcon: React.FC<{ className?: string }> = ({ className = "h-3.5 w-3.5" }) => (
...
// 勾选图标组件
export const CheckIcon: React.FC<{ className?: string }> = ({ className = "h-3.5 w-3.5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// 关闭图标组件
export const CloseIcon: React.FC<{ className?: string }> = ({ className = "h-4 w-4" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const LoadingSpinner: React.FC<{ className?: string }> = ({ className = "h-4 w-4" }) => (
  <svg className={clsx("animate-spin text-white", className)} fill="none" viewBox="0 0 24 24">
...
// 退出登录图标组件
export const LogoutIcon: React.FC<{ className?: string }> = ({ className = "h-4 w-4" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
